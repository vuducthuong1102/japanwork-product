...
namespace MySite.Caching.Providers
{
    /// <summary>
    ...
    public class RedisCacheProvider : CacheProviderBase
    {
        ...
        */
        ...
        public override void SetBySeconds<T>(string key, T value, int duration)
        {
            _redisCacheClient.Add<T>(key, value, TimeSpan.FromSeconds(duration));
        }
