...
namespace MySite.Services
{
    public class ApplicationServices
    {
        ...
        public static async Task<ApiResponseCommonModel> ApplyJobAsync(ApiJobActionApplyModel model)
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/applications");
        ...
        public static async Task<ApiResponseCommonModel> SendCvAsync(ApiApplicationSendCvModel model)
        {
            var currentAction = "SendCvAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/applications/send_cv");
        ...
        public static async Task<ApiResponseCommonModel> CancelAsync(ApiApplicationCancelModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/cancels", SystemSettings.MySiteApi, "api/applications", model.id);
