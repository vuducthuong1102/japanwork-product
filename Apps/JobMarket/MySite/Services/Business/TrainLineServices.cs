...
namespace MySite.Services
{
    public class TrainLineServices
    {
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync()
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/train_lines");
        ...
        public static async Task<ApiResponseCommonModel> GetListByCityIdAsync(int id, string keyword)
        {
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/get_list_by_city_id?keyword={3}", SystemSettings.MySiteApi, "api/train_lines", id, keyword);
            try
            {
                var client = new HttpClient();
                client.Timeout = TimeSpan.FromSeconds(SystemSettings.ExternalServiceTimeout);
        ...
        public static async Task<ApiResponseCommonModel> GetDetailAsync(int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}", SystemSettings.MySiteApi, "api/train_lines", id);
        ...
        public static async Task<ApiResponseCommonModel> GetSuggestionsByPagingAsync(ApiGetTrainLineByPageModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}?keyword={2}&page_index={3}&page_size={4}&place_id={5}", SystemSettings.MySiteApi, "api/train_lines/get_suggestions", model.keyword, model.page_index, model.page_size, model.place_id);
        ...
        public static async Task<ApiResponseCommonModel> GetListByCityIdAsync(int id)
        {
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/get_list_by_city_id", SystemSettings.MySiteApi, "api/train_lines",id);
            try
            {
                var client = new HttpClient();
                client.Timeout = TimeSpan.FromSeconds(SystemSettings.ExternalServiceTimeout);
