...
namespace MySite.Services
{
    ...
    {
        private static readonly ILog logger = LogProvider.For<FieldServices>();
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync()
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/fields");
        ...
        public static async Task<ApiResponseCommonModel> GetListCountAsync()
        {
            var currentAction = "GetListCountAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/fields/get_list_count");
