...
{
    public class JapaneseLevelServices
    {
        private static readonly ILog logger = LogProvider.For<JapaneseLevelServices>();
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync()
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/japanese_levels");
