...
namespace MySite.Services
{
    public class CityServices
    {
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync()
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/cities");
        ...
        public static async Task<ApiResponseCommonModel> GetByPagingAsync(ApiGetListByPageModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}?keyword={2}&page_index={3}&page_size={4}", SystemSettings.MySiteApi, "api/cities/get_by_page", model.keyword, model.page_index, model.page_size);
