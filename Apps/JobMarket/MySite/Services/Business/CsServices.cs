...
namespace MySite.Services
{
    ...
    {
        private static readonly ILog logger = LogProvider.For<CsServices>();

        public static async Task<ApiResponseCommonModel> CreateAsync(ApiCsUpdateModel model)
        {
            var currentAction = "CreateAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/cs");
        ...
        public static async Task<ApiResponseCommonModel> UpdateAsync(ApiCsUpdateModel model)
        {
            var currentAction = "UpdateAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/cs/update");
        ...
        public static async Task<ApiResponseCommonModel> GetDetailAsync(int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}", SystemSettings.MySiteApi, "api/cs", id);
        ...
        public static async Task<ApiResponseCommonModel> DeleteAsync(ApiCsDeleteModel model)
        {
        ...
        public static async Task<ApiResponseCommonModel> SetMainCsAsync(ApiSetMainCsModel model)
        {
            var currentAction = "SetMainCsAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/cs/set_main_cs");
        ...
        public static async Task<ApiResponseCommonModel> UploadImageAsync(ApiCsUploadImageModel model, HttpPostedFileBase image_file_upload = null)
        {
            var currentAction = "UploadImageAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/cs/upload_image");
            ...
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    using (var content = new MultipartFormDataContent())
                    {
                        ...
                        content.Add(new StringContent(model.cs_id.ToString()),"cs_id");
        ...
        public static async Task<ApiResponseCommonModel> GetEduHistoryAsync(ApiGetListByPageModel model, int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/edu_histories", SystemSettings.MySiteApi, "api/cs", id);
        ...
        public static async Task<ApiResponseCommonModel> GetWorkHistoryAsync(ApiGetListByPageModel model, int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/work_histories", SystemSettings.MySiteApi, "api/cs", id);
        ...
        public static async Task<ApiResponseCommonModel> GetCertificateAsync(ApiGetListByPageModel model, int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/certificates", SystemSettings.MySiteApi, "api/cs", id);
        ...
        public static async Task<ApiResponseCommonModel> GetSuggestionsByPagingAsync(ApiGetListByPageModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}?keyword={2}&page_index={3}&page_size={4}&job_seeker_id={5}", SystemSettings.MySiteApi, "api/cs/get_suggestions", model.keyword, model.page_index, model.page_size, model.job_seeker_id);
        ...
        public static async Task<ApiResponseCommonModel> CloneAsync(ApiCsModel model)
        {
            var currentAction = "CloneAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/cs/clone");
