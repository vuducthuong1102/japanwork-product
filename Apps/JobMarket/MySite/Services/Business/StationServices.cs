...
namespace MySite.Services
{
    ...
    {
        private static readonly ILog logger = LogProvider.For<StationServices>();
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync()
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/station");
        ...
        public static async Task<ApiResponseCommonModel> GetListByPositionAsync(int line_id)
        {
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/get_list_by_position", SystemSettings.MySiteApi, "api/stations", line_id);
            try
            {
                var client = new HttpClient();
                client.Timeout = TimeSpan.FromSeconds(SystemSettings.ExternalServiceTimeout);
        ...
        public static async Task<ApiResponseCommonModel> GetDetailAsync(int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}", SystemSettings.MySiteApi, "api/stations", id);
        ...
        public static async Task<ApiResponseCommonModel> GetSuggestionsByPagingAsync(ApiGetStationByPageModel model)
        {
            var currentAction = "GetSuggestionsByPagingAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}?keyword={2}&page_index={3}&page_size={4}&place_id={5}", SystemSettings.MySiteApi, "api/stations/get_suggestions", model.keyword, model.page_index, model.page_size, model.place_id);
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync(ApiGetListByIdsModel model)
        {
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/stations");
        ...
        public static async Task<ApiResponseCommonModel> GetListByPositionAsync(int line_id, int city_id)
        {
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/get_list_by_position?city_id={3}", SystemSettings.MySiteApi, "api/stations", line_id, city_id);
            try
            {
                var client = new HttpClient();
                client.Timeout = TimeSpan.FromSeconds(SystemSettings.ExternalServiceTimeout);
