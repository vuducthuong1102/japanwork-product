...
namespace MySite.Services
{
    public class UserServices
    {
        ...
        public static async Task<ResponseApiModel> GetFollowers(ApiFollowUserModel model)
        {
            var strError = string.Empty;
            var result = new ResponseApiModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/user/getfollowers");
            ...
            {
                strError = string.Format("Failed when calling api to GetFollowers - {0} because: {1}", _baseUrl, ex.ToString());
        ...
        public static async Task<ResponseApiModel> GetFollowings(ApiFollowUserModel model)
        {
            var strError = string.Empty;
            var result = new ResponseApiModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MySiteApi, "api/user/getfollowings");
            ...
            {
                strError = string.Format("Failed when calling api to GetFollowings - {0} because: {1}", _baseUrl, ex.ToString());
                logger.Error(strError);
