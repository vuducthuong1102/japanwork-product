...
//        private IdentityUser GetUserByInfo(string info, string type = "EMAIL")
//        {
//            IdentityUser userInfo = null;
//            if (type == "EMAIL")
//            {
//                var apimodel = new ApiGetUserByEmailModel();
//                apimodel.Email = info;
//                var returnApi = AccountServices.GetUserByEmailAsync(apimodel).Result;
//                if (returnApi != null && returnApi.Data != null)
//                {
//                    userInfo = JsonConvert.DeserializeObject<IdentityUser>(returnApi.Data.ToString());
//                }
//            }
//            else if (type == "PHONENUMBER")
//            {
//                var apimodel = new ApiGetUserByPhoneNumberModel();
//                apimodel.PhoneNumber = info;
//                var returnApi = AccountServices.GetUserByPhoneNumberAsync(apimodel).Result;
//                if (returnApi != null && returnApi.Data != null)
//                {
//                    userInfo = JsonConvert.DeserializeObject<IdentityUser>(returnApi.Data.ToString());
//                }
...
//        [PreventCrossOrigin]
//        [CaptchaValidator(ErrorMessage = nameof(UserWebResource.COMMON_ERROR_CAPTCHA_INVALID))]
//        public async Task<ActionResult> RecoverPassword_Post(WebRecoverPasswordModel model, bool captchaValid)
//        {
...
//            try
//            {
//                var hasPassword = Utility.Md5HashingData(model.NewPassword);
...
//                    identityUser = GetUserByInfo(model.Answer, "EMAIL");

//                    if (identityUser == null)
//                    {
//                        result = UserWebResource.COMMON_ERROR_INFO_NOTFOUND;
//                        this.AddNotification(result, NotificationType.ERROR);

//                        return View(model);
//                    }

//                    var apichangemodel = new ApiChangePassword1Model();
//                    apichangemodel.UserId = identityUser.Id;
//                    apichangemodel.NewPassword = hasPassword;
//                    apichangemodel.PasswordType = model.PasswordType;

//                    var resultSendMail = await AccountServices.RecoverPasswordStep1Async(apichangemodel);

//                    if (resultSendMail.Code == EnumCommonCode.Success)
//                    {
//                        isSuccess = true;
//                        //result = string.Format(EmailResource.NOTIF_EMAIL_SENT_FORMAT, identityUser.Email);
//                    }
//                    else
//                    {
...
//                    if (string.IsNullOrEmpty(model.Answer))
//                    {
//                        this.AddNotification(UserWebResource.COMMON_ERROR_PHONENUMBER_NULL, NotificationType.ERROR);
//                        return View(model);
//                    }

//                    identityUser = GetUserByInfo(model.Answer, "PHONENUMBER");
//                    if(identityUser == null)
//                    {
//                        result = UserWebResource.COMMON_ERROR_INFO_NOTFOUND;
//                        this.AddNotification(result, NotificationType.ERROR);
...
//                    var apimodel = new ApiRecoverPasswordOTPModel();
//                    apimodel.PhoneNumber = model.Answer;
//                    apimodel.NewPassword = hasPassword;
//                    apimodel.ConfirmPassword = hasPassword;
//                    apimodel.PasswordLevel = PasswordLevelType.Level1;

//                    var returnApi = await AccountServices.RecoverPasswordOTPAsync(apimodel);
//                    if (returnApi != null)
//                    {
//                        if (returnApi.Code == EnumCommonCode.Success)
//                        {
//                            this.AddNotification(returnApi.Msg, NotificationType.SUCCESS);

//                            return View("VerifyOTP", new WebVerifyOTPModel { PhoneNumber = apimodel.PhoneNumber, ActionType = ActionType.RecoverPassword1, UserId = identityUser.Id, TokenKey = identityUser.TokenKey });
//                        }
//                        else
//                        {
//                            this.AddNotification(returnApi.Msg, NotificationType.ERROR);
//                        }
//                    }
//                    else
//                    {
//                        result = UserWebResource.COMMON_ERROR_PHONE_INVALID;
//                    }
//                }
