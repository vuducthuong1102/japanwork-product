...
namespace MySite
{
    ...
    {
        //public static string GetNameLocationByLanguage(string rawData, string type="")
        //{
        //    string result = "";
        //    var currenrLang = UserCookieManager.GetCurrentLanguageOrDefault();
        //    List<AddressComponentLanguage> ListAddress = new List<AddressComponentLanguage>();

        //    try
        //    {
        //        if (rawData != null)
        //        {
        //            ListAddress = JsonConvert.DeserializeObject<List<AddressComponentLanguage>>(rawData);

        //            if (ListAddress != null && ListAddress.Count > 0)
        //            {
        //                foreach (var item in ListAddress)
        //                {
        //                    if (item.languagecode == currenrLang)
        //                    {
        ...
        //                if (string.IsNullOrEmpty(result))
        //                {
        //                    result = ListAddress[0].model.name;
        //                }
        //            }
        //        }
        //    }
