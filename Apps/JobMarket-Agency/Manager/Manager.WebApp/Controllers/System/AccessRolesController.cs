...
namespace Manager.WebApp.Controllers
{
    public class AccessRolesController : BaseAuthedController
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                model.AllRoles = new RoleRepository(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString).GetRoleByUserId(GetCurrentAgencyId()).OrderBy(m => m.Name).ToList();
