...
{
    public class AvatarController : BaseAuthedController
    {
        ...
        private const string TempFolder = "/Upload/Avatars/Temp";
        private const string MapTempFolder = "~" + TempFolder;
        private const string AvatarPath = "/Upload/Avatars";
        ...
        public ActionResult Save(string t, string l, string h, string w, string fileName)
        {
            try
            {
                ...
                var heightPos = img.Height - top - ImageSettings.AvatarHeight;
                var widthPos = img.Width - left - ImageSettings.AvatarWidth;

                if (heightPos < 0) heightPos = 0;
                if (widthPos < 0) widthPos = 0;

                img.Crop(top, left, heightPos, widthPos);
