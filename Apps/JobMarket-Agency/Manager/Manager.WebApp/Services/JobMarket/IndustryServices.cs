...
namespace Manager.WebApp.Services
{
    ...
    {
        private static readonly ILog logger = LogProvider.For<IndustryServices>();
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync()
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/industries");
        ...
        public static async Task<ApiResponseCommonModel> GetListSubAsync()
        {
            var currentAction = "GetListAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/industries/getsub");
