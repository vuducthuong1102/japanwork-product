...
namespace Manager.WebApp.Services
{
    public class StationServices
    {
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync()
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/station");
        ...
        public static async Task<ApiResponseCommonModel> GetListByCityIdAsync(int city_id)
        {
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/get_list_by_city_id", SystemSettings.MainApi, "api/stations", city_id);
            try
            {
                var client = new HttpClient();
                client.Timeout = TimeSpan.FromSeconds(SystemSettings.ExternalServiceTimeout);
        ...
        public static async Task<ApiResponseCommonModel> GetListByPositionAsync(int line_id)
        {
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/get_list_by_position", SystemSettings.MainApi, "api/stations", line_id);
            try
            {
                var client = new HttpClient();
                client.Timeout = TimeSpan.FromSeconds(SystemSettings.ExternalServiceTimeout);
        ...
        public static async Task<ApiResponseCommonModel> GetDetailAsync(int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}", SystemSettings.MainApi, "api/stations", id);
        ...
        public static async Task<ApiResponseCommonModel> GetSuggestionsByPagingAsync(ApiGetStationByPageModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}?keyword={2}&page_index={3}&page_size={4}&place_id={5}", SystemSettings.MainApi, "api/stations/get_suggestions", model.keyword, model.page_index, model.page_size, model.place_id);
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync(ApiGetListByIdsModel model)
        {
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/stations");
