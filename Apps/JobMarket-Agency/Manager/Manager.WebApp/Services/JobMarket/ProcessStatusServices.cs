...
{
    public class ProcessStatusServices
    {
        private static readonly ILog logger = LogProvider.For<ProcessStatusServices>();
        ...
        public static async Task<ApiResponseCommonModel> GetDetailAsync(int id)
        {
            ...
            var _baseUrl = string.Format("{0}/api/processstatus/{1}", SystemSettings.MainApi, id);
        ...
        public static async Task<ApiResponseCommonModel> GetByPageAsync(ApiCompanyModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/api/processstatus/{1}", SystemSettings.MainApi, model.id);
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync(int agency_id)
        {
            var currentAction = "GetListAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/api/processstatus/{1}/get_list", SystemSettings.MainApi, agency_id);
        ...
        public static async Task<ApiResponseCommonModel> InsertAsync(ApiProcessStatusInsertModel model)
        {
            var currentAction = "InsertAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/processstatus");
        ...
        public static async Task<ApiResponseCommonModel> UpdateAsync(ApiProcessStatusEditModel model)
        {
        ...
        public static async Task<ApiResponseCommonModel> UpdateSortingAsync(List<SortingElement> model, int agency_id)
        {
            var currentAction = "UpdateSortingAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}/sorting", SystemSettings.MainApi, "api/processstatus", agency_id);
        ...
        public static async Task<ApiResponseCommonModel> DeleteAsync(int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}", SystemSettings.MainApi, "api/processstatus", id);
