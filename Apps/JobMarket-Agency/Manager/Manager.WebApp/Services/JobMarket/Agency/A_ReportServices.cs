...
{
    public class A_ReportServices
    {
        private static readonly ILog logger = LogProvider.For<A_ReportServices>();

        public static async Task<ApiResponseCommonModel> JobByYearAsync(ApiAgencyReportByYearModel model)
        {
            var currentAction = "JobByYearAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/A_Report/job_by_year");
        ...
        public static async Task<ApiResponseCommonModel> JobByWeekAsync(ApiAgencyReportByWeekModel model)
        {
            var currentAction = "JobByWeekAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/A_Report/job_by_week");
        ...
        public static async Task<ApiResponseCommonModel> ApplicationByWeekAsync(ApiAgencyReportByWeekModel model)
        {
            var currentAction = "ApplicationByWeekAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/A_Report/application_by_week");
