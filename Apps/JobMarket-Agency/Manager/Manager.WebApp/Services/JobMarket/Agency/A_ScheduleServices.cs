...
{
    public class A_ScheduleServices
    {
        private static readonly ILog logger = LogProvider.For<A_ScheduleServices>();

        public static async Task<ApiResponseCommonModel> UpdateAsync(ApiScheduleModel model)
        {
            var currentAction = "UpdateAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/A_schedules");
        ...
        public static async Task<ApiResponseCommonModel> UpdateScheduleTimeAsync(ApiScheduleModel model)
        {
            var currentAction = "UpdateScheduleTimeAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/A_schedules/update_time");
        ...
        public static async Task<ApiResponseCommonModel> GetDetailAsync(ApiScheduleModel model)
        {
            var currentAction = "GetDetailAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/A_schedules/detail");
        ...
        public static async Task<ApiResponseCommonModel> DeleteAsync(ApiScheduleModel model)
        {
