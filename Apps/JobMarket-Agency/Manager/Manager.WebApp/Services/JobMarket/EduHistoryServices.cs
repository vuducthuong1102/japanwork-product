...
namespace Manager.WebApp.Services
{
    public class EduHistoryServices
    {
        ...
        public static async Task<ApiResponseCommonModel> JobSeekerUpdateAsync(ApiJobSeekerEduHistoryModel model)
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/edu_histories");
        ...
        public static async Task<ApiResponseCommonModel> JobSeekerGetDetailAsync(ApiJobSeekerEduHistoryModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/edu_histories/detail");
        ...
        public static async Task<ApiResponseCommonModel> CvUpdateAsync(ApiCvEduHistoryModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/edu_histories/cv_update");
        ...
        public static async Task<ApiResponseCommonModel> CvGetDetailAsync(ApiCvEduHistoryModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/edu_histories/cv_detail");
        ...
        public static async Task<ApiResponseCommonModel> CvDeleteAsync(ApiCvEduHistoryModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/edu_histories/cv_delete");
