...
{
    public class JobSeekerNoteServices
    {
        private static readonly ILog logger = LogProvider.For<JobSeekerNoteServices>();
        ...
        public static async Task<ApiResponseCommonModel> GetDetailAsync(int id)
        {
            ...
            var _baseUrl = string.Format("{0}/api/job_seeker_note/{1}", SystemSettings.MainApi, id);
        ...
        public static async Task<ApiResponseCommonModel> GetByPageAsync(ApiJobSeekerNoteModel model)
        {
            var currentAction = "GetByPageAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/api/job_seeker_note/getbypage", SystemSettings.MainApi);
        ...
        public static async Task<ApiResponseCommonModel> InsertAsync(ApiJobSeekerNoteUpdateModel model)
        {
            var currentAction = "InsertAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/job_seeker_note");
        ...
        public static async Task<ApiResponseCommonModel> UpdateAsync(ApiJobSeekerNoteUpdateModel model)
        {
        ...
        public static async Task<ApiResponseCommonModel> DeleteAsync(int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}/{2}", SystemSettings.MainApi, "api/job_seeker_note", id);
