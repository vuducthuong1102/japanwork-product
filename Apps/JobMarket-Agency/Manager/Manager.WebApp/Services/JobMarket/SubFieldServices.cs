...
{
    public class SubFieldServices
    {
        private static readonly ILog logger = LogProvider.For<SubFieldServices>();
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync()
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/sub_fields");
