...
{
    public class ManageCurrencyModel : CommonPagingModel
    {
        public static string DATETIME_FORMAT = "MM/dd/yyyy h:mm tt";

        public List<IdentityCurrency> SearchResults { get; set; }
    ...
    public class CurrencyCommonInfoModel
    {
        [Display(ResourceType = typeof(Resources.ManagerResource), Name = nameof(ManagerResource.LB_NAME))]
    ...
    public class CurrencyCreateModel : CurrencyCommonInfoModel
    {

    }

    public class CurrencyEditModel : CurrencyCommonInfoModel
    {
