...
namespace Manager.WebApp.Models
{
    ...
    public class ApiInvitationItemModel
    {
        public int cv_id { get; set; }
        public int job_seeker_id { get; set; }
    }

    public class ApiJobInvitationModel
    {
        [Required(ErrorMessageResourceType = typeof(ManagerResource), ErrorMessageResourceName = nameof(ManagerResource.ERROR_ALEAST_ONE_APPLICANT_SELECT))]
        public string applicant { get; set; }

        public List<int> JobSeekers { get; set; }
        public int agency_id { get; set; }
        public int staff_id { get; set; }
        public int job_id { get; set; }
