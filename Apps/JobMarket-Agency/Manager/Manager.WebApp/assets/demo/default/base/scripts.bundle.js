                ...
                var h = {
                    ...
                    adjustCellsWidth: function () {
                        ...
                        if (0 < t) {
                            var col = 0;
                            var e_fix = 0;
                            b(g.table).find("tr:first").find(".m-datatable__cell:visible").each(function (e, t) {
                                var n = b(t).data("width");
                                if (!b(t).hasClass("prefix-width")) {
                                    if (n === undefined) {
                                        col++;
                                    }
                                    else {
                            ...
                            var o = 0;
                            if (col > 0) {
                                o = Math.floor((size * (100 - e_fix)) / (100 * col));
                            }
