...
namespace MyCloud.Helpers
{
    public static class MyExtensions
    {
        ...
        public static bool BrowserIsMobile(NameValueCollection serverVars)
        {
            var u = serverVars["HTTP_USER_AGENT"].ToString();
            if (u.Length < 4)
                return false;
        ...
        public static bool CheckListHasData<T>(this List<T> myList)
        {
        ...
        public static bool CheckArrHasData<T>(this T[] myArr)
        {
