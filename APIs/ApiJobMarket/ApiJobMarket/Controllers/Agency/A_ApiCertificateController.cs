...
{
    [Authorize]
    [RoutePrefix("api/A_certificates")]
    public class A_ApiCertificateController : BaseApiController
    {
        private readonly ILog logger = LogProvider.For<A_ApiCertificateController>();
        ...
        public async Task<IHttpActionResult> GetDetail(ApiJobSeekerCertificateModel model)
        {
            ...
            var requestName = "A_Certificates-GetDetail";
            ...
            try
            {
                ...
                var info = storeCertificate.A_JobSeekerGetDetail(id, job_seeker_id);
        ...
        {
            CreateDocumentApi(model);
            var requestName = "A_Certificates-UpdateCertificate";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            ...
            try
            {
                ...
                var result = storeCertificate.A_JobSeekerUpdate(updateInfo);
        ...
        {
            CreateDocumentApi(model);
            var requestName = "A_Certificates-Delete";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
            ...
            try
            {
                ...
                var result = storeCertificate.A_JobSeekerDelete(info);
                await Task.FromResult(result);
        ...
        {
            CreateDocumentApi(model);
            var requestName = "A_Certificates-CvGetDetail";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        {
            CreateDocumentApi(model);
            var requestName = "A_Certificates-CvUpdateCertificate";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            var logoPath = string.Empty;
        ...
        {
            CreateDocumentApi(model);
            var requestName = "A_Certificates-CvDelete";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        {
            CreateDocumentApi(model);
            var requestName = "A_Certificates-CsGetDetail";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        {
            CreateDocumentApi(model);
            var requestName = "A_Certificates-CsUpdateCertificate";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            var logoPath = string.Empty;
        ...
        {
            CreateDocumentApi(model);
            var requestName = "A_Certificates-CsDelete";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
