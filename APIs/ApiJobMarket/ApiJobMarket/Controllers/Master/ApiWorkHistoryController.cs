...
{
    [Authorize]
    [RoutePrefix("api/work_histories")]
    public class ApiWorkHistoryController : BaseApiController
    {
        private readonly ILog logger = LogProvider.For<ApiWorkHistoryController>();
        ...
        public async Task<IHttpActionResult> GetDetail(ApiJobSeekerWorkHistoryModel model)
        {
            ...
            var requestName = "Work_Histories-GetDetail";
            ...
            try
            {
                ...
                var info = storeWorkHistory.JobSeekerGetDetail(id, job_seeker_id);
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Work_Histories-UpdateWorkHistory";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            ...
            try
            {
                ...
                var result = storeWorkHistory.JobSeekerUpdate(updateInfo);
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Work_Histories-Delete";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
            ...
            try
            {
                ...
                var result = storeWorkHistory.JobSeekerDelete(info);
                await Task.FromResult(result);
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Work_Histories-CvGetDetail";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Work_Histories-CvUpdateWorkHistory";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            var logoPath = string.Empty;
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Work_Histories-CvDelete";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Work_Histories-CsGetDetail";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Work_Histories-CsUpdateWorkHistory";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            var logoPath = string.Empty;
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Work_Histories-CsDelete";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        private IdentityJobSeekerWorkHistory ExtractWorkHistoryFormData(ApiJobSeekerWorkHistoryModel model)
        {
            ...
            info.start_date = Utils.ConvertStringToDateTimeByFormat(model.start_date, DATE_FORMAT);
            info.end_date = Utils.ConvertStringToDateTimeByFormat(model.end_date, DATE_FORMAT);
