...
namespace ApiJobMarket.Controllers
{
    ...
    public class ApiFieldController : BaseApiController
    {
        private readonly ILog logger = LogProvider.For<ApiFieldController>();

        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetList()
        {
            var requestName = "Fields-GetList";
            ...
            try
            {
                ...
                var listField = CommonHelpers.GetListFields();

                await Task.FromResult(listField);                

                returnModel.value = listField;
        ...
        public async Task<IHttpActionResult> GetListCount()
        {
            ...
            try
            {
                ...
                var listField = CommonHelpers.F_GetListCount();
        ...
        public async Task<IHttpActionResult> GetDetail(int id)
        {
            ...
            var requestName = "Fields-GetDetail";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            ...
            try
            {
                ...
                var info = storeField.GetById(id);
