...
{
    [Authorize]
    [RoutePrefix("api/salaryfilter")]
    public class ApiSalaryFilterController : BaseApiController
    {
        private readonly ILog logger = LogProvider.For<ApiSalaryFilterController>();

        [HttpGet]
        [Route("")]
        public async Task<IHttpActionResult> GetAll()
        {
            var requestName = "SalaryFilter-GetAll";
            ...
            try
            {
                ...
                var listResult = CommonHelpers.GetListSalaryFilters();
        ...
        public async Task<IHttpActionResult> GetDetail(int id)
        {
            ...
            var requestName = "SalaryFilter-GetDetail";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
        ...
        {
            var requestName = "SalaryFilter-Delete";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Update(ApiSalaryFilterEditModel model)
        {
            CreateDocumentApi(model);
            var requestName = "SalaryFilter-Update";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            ...
            try
            {
                ...
                var identity = new IdentitySalaryFilter()
                {
                    id = model.id,
                    max = model.max,
                    min = model.min,
        ...
        [HttpPut]
        [Route("")]
        public async Task<IHttpActionResult> Insert(ApiSalaryFilterInsertModel model)
        {
            CreateDocumentApi(model);
            var requestName = "SalaryFilter-Insert";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            var logoPath = string.Empty;
