...
{
    [Authorize]
    [RoutePrefix("api/edu_histories")]
    public class ApiEduHistoryController : BaseApiController
    {
        private readonly ILog logger = LogProvider.For<ApiEduHistoryController>();
        ...
        public async Task<IHttpActionResult> GetDetail(ApiJobSeekerEduHistoryModel model)
        {
            ...
            var requestName = "Edu_Histories-GetDetail";
            ...
            try
            {
                ...
                var info = storeEduHistory.JobSeekerGetDetail(id, job_seeker_id);
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Edu_Histories-UpdateEduHistory";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            ...
            try
            {
                ...
                var result = storeEduHistory.JobSeekerUpdate(updateInfo);
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Edu_Histories-Delete";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
            ...
            try
            {
                ...
                var result = storeEduHistory.JobSeekerDelete(info);
                await Task.FromResult(result);
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Edu_Histories-CvGetDetail";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Edu_Histories-CvUpdateEduHistory";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            var logoPath = string.Empty;
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Edu_Histories-CvDelete";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Edu_Histories-CsGetDetail";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Edu_Histories-CsUpdateEduHistory";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            var logoPath = string.Empty;
        ...
        {
            CreateDocumentApi(model);
            var requestName = "Edu_Histories-CsDelete";
            var returnModel = new ApiResponseCommonModel();
            var jsonString = string.Empty;
            if (!ModelState.IsValid)
            {
