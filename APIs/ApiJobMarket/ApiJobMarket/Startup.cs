...
[assembly: OwinStartup(typeof(ApiJobMarket.Startup))]
namespace ApiJobMarket
{
    public class Startup
    {
        ...
        {           
            ...
            logger.Info("======================================================");
            logger.Info("ApiJobMarket is starting up");
            logger.Info("======================================================");
            ...
            logger.Info("======================================================");
            logger.Info("ApiJobMarket is successfully configured");
            logger.Info("======================================================");
        }
        ...
        private void RegisterCorsPolicy(IAppBuilder app)
        {
            ...
            */
            ...
            var origins = ApiJobMarketSettings.AllowedCorsOrigins;
    ...
    public sealed class SignalrConnection
    {
        ...
        public static string _hubName = string.Empty;
        private SignalrConnection()
        {
            InitSignalrConnection(_hubName);
        ...
        {
            var signalRServerUrl = MyCloudSettings.MyCloudServer;
