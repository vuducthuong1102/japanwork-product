...
[assembly: OwinStartup("SingleSignOn", typeof(SingleSignOn.Startup))]
namespace SingleSignOn
{
    public class Startup
    {
        ...
        {           
            ...
            logger.Info("======================================================");
            logger.Info("SingleSignOn is starting up");
            logger.Info("======================================================");
           ...
           //);
            ...
            logger.Info("======================================================");
            logger.Info("SingleSignOn is successfully configured");
            logger.Info("======================================================");
        }
        ...
        private void RegisterCorsPolicy(IAppBuilder app)
        {
            ...
            */
            ...
            var origins = SingleSignOnSettings.AllowedCorsOrigins;
