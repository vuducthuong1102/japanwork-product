...
namespace SingleSignOn.Settings
{
    public class SingleSignOnSettings
    {
        ...
        public static string SingleSignOnDB
        {
            get
            {
                return ConfigurationManager.AppSettings["SingleSignOnDB"];
            }
        }
    ...
    {
        public static string ImageContainerServer
        {
            get
            {
                return ConfigurationManager.AppSettings["Img:ContainerServer"];
            }
        }

        public static string CdnReadContentLink
        {
            get
            {
                return ConfigurationManager.AppSettings["Img:CdnReadContentLink"];
            }
        }
