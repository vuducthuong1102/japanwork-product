...
namespace SingleSignOn.Models
{
    ...
    {
        [Required(ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_USERNAME_NULL))]
        ...
        [Display(ResourceType = typeof(Resources.UserWebResource), Name = nameof(UserWebResource.TEXT_LOGIN_ACCOUNT))]
    ...
    public class WebAccountRegisterModel
    {
        ...
        [MinLength(6, ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_LESS_6_CHARACTERS))]
        [MaxLength(50, ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_OVER_50_CHARACTERS))]
        [Display(ResourceType = typeof(Resources.UserWebResource), Name = nameof(UserWebResource.TEXT_ACCOUNT))]
        public string UserName { get; set; }

        [Required(ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_PASSWORD_NULL))]
        [MinLength(6, ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_LESS_6_CHARACTERS))]
        [MaxLength(50, ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_OVER_50_CHARACTERS))]
        [Display(ResourceType = typeof(Resources.UserWebResource), Name = nameof(UserWebResource.TEXT_PASSWORD))]
        [JsonIgnore]
        public string Password { get; set; }

        [Compare("Password", ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_CONFIRMPWD_INCORRECT))]
        [MinLength(6, ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_LESS_6_CHARACTERS))]
        [MaxLength(50, ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_OVER_50_CHARACTERS))]
        [Display(ResourceType = typeof(Resources.UserWebResource), Name = nameof(UserWebResource.TEXT_CONFIRM_PASSWORD))]
        [JsonIgnore]
        ...
        [Display(ResourceType = typeof(Resources.UserWebResource), Name = nameof(UserWebResource.TEXT_EMAIL))]
        ...
        [Display(ResourceType = typeof(Resources.UserWebResource), Name = nameof(UserWebResource.TEXT_PHONE))]
    ...
    {
        [Display(ResourceType = typeof(Resources.UserWebResource), Name = nameof(UserWebResource.TEXT_NEW_PASSWORD))]
        [Required(ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_PASSWORD_NULL))]
        [MinLength(6, ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_LESS_6_CHARACTERS))]
        [MaxLength(50, ErrorMessageResourceType = typeof(UserWebResource), ErrorMessageResourceName = nameof(UserWebResource.COMMON_ERROR_OVER_50_CHARACTERS))]
        public string NewPassword { get; set; }
