...
namespace SingleSignOn.DB.Sql.Stores
{
    public class StoreUser : IStoreUser
    {
        ...
        {
            return myRepository.ResendEmailActive(info);
        }

        public int SendEmailRecoverPassword(IdentityUser info, string hasData)
        {
            return myRepository.SendEmailRecoverPassword(info, hasData);
        }

        public int RecoverPassword(IdentityUser info, string hasData)
        {
            return myRepository.RecoverPassword(info, hasData);
        }
    }
    ...
    public interface IStoreUser
    {
        ...
        int SendEmailRecoverPassword(IdentityUser info, string hasData);
        int RecoverPassword(IdentityUser info, string hasData);
    }
}
