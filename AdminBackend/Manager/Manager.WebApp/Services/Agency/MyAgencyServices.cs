...
{
    public class MyAgencyServices
    {
        private static readonly ILog logger = LogProvider.For<MyAgencyServices>();
        ...
        public static async Task<ApiResponseCommonModel> GetListOperatorsForMessengerAsync(ApiCommonFilterModel model)
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.AgencyServer, "api/user/operators");
        ...
        public static async Task<ApiResponseCommonModel> GetOperatorProfileAsync(ApiCommonOperatorInfoModel model)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.AgencyServer, "api/user/operator");
