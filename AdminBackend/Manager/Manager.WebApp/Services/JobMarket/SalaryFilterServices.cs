...
{
    public class SalaryFilterServices
    {
        private static readonly ILog logger = LogProvider.For<SalaryFilterServices>();
        ...
        //    var _baseUrl = string.Format("{0}/api/salaryfilter", SystemSettings.MainApi);
        ...
        public static async Task<ApiResponseCommonModel> DeleteAsync(int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/api/salaryfilter/{1}", SystemSettings.MainApi, id);
        ...
        public static async Task<ApiResponseCommonModel> UpdateAsync(ApiSalaryFilterEditModel model)
        {
            var currentAction = "UpdateAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/salaryfilter");
        ...
        public static async Task<ApiResponseCommonModel> InsertAsync(ApiSalaryFilterInsertModel model)
        {
