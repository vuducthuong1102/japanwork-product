...
{
    public class CompanySizeServices
    {
        private static readonly ILog logger = LogProvider.For<CompanySizeServices>();
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync()
        {
            ...
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/company_sizes");
