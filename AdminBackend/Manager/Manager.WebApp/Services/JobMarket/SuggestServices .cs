...
namespace Manager.WebApp.Services
{
    ...
    {
        private static readonly ILog logger = LogProvider.For<SuggestServices>();
        ...
        public static async Task<ApiResponseCommonModel> GetByPageAsync(ApiSuggestSearchModel model)
        {
            ...
            var _baseUrl = string.Format("{0}/api/example_all/get_by_page", SystemSettings.MainApi);
        ...
        public static async Task<ApiResponseCommonModel> DeleteAsync(int id)
        {
            ...
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/api/example_all/{1}", SystemSettings.MainApi, id);
        ...
        public static async Task<ApiResponseCommonModel> GetListAsync(int type, int form)
        {
            var currentAction = "GetListAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/api/example_all?type={1}&form={2}", SystemSettings.MainApi, type, form);
        ...
        public static async Task<ApiResponseCommonModel> UpdateAsync(ApiSuggestEditModel model)
        {
            var currentAction = "UpdateAsync";
            var strError = string.Empty;
            var result = new ApiResponseCommonModel();
            var _baseUrl = string.Format("{0}/{1}", SystemSettings.MainApi, "api/example_all");
        ...
        public static async Task<ApiResponseCommonModel> InsertAsync(ApiSuggestInsertModel model)
        {
