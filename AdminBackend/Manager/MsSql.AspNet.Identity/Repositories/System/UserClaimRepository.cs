    ...
    public class UserClaimRepository<TUser>  where TUser : IdentityUser
    {
        ...
        public void Insert(TUser user, Claim claim)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                ...
                MsSqlHelper.ExecuteNonQuery(conn, @"INSERT INTO AspNetUserClaims(UserId,ClaimType,ClaimValue) VALUES(@UserId,@ClaimType,@ClaimValue)", parameters);
            }
        }
        ...
        public void Delete(TUser user, Claim claim)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                ...
                MsSqlHelper.ExecuteNonQuery(conn,
